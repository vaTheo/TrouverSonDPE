...
import { ResultatDis } from '../../datarating/fetch-eau/api-eau';
import { getFormattedDateYearsAgoAsString } from '../../datarating/fetch-address/addressFunction';
...
import { saveDataToFile } from '../../../utils/utilities';
